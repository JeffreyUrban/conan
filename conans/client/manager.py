...
def deps_install(app, ref_or_path, install_folder, graph_info, remotes=None, build_modes=None,
                 ...
                 create_reference=None, keep_build=False, keep_source=True, use_lock=False, recorder=None):
    ...
    installer.install(deps_graph, remotes, build_modes, update, keep_build=keep_build, keep_source=keep_source,
